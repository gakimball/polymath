...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.color'
        db.add_column(u'music_album', 'color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Track.color'
        db.add_column(u'music_track', 'color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.color'
        db.delete_column(u'music_album', 'color')

        # Deleting field 'Track.color'
        db.delete_column(u'music_track', 'color')
