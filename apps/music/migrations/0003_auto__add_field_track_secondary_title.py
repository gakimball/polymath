...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.secondary_title'
        db.add_column(u'music_track', 'secondary_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.secondary_title'
        db.delete_column(u'music_track', 'secondary_title')
