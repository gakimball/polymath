...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Credit.role'
        db.alter_column('people_credit', 'role', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Credit.role'
        db.alter_column('people_credit', 'role', self.gf('django.db.models.fields.TextField')())
